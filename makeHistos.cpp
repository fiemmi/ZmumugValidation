...
void makeHistos(std::string_view file, std::string_view tree, bool isdata, TString year) {
  ...
  auto f_sel = d0.Filter("mass_ScaleSmeared>80. && mass_ScaleSmeared<100. &&event_PassHLT_DiMu>0 && ( (fabs(pho_sceta) < 1.479 && pho_full5x5_r9Corr > 0.85 && pho_full5x5_r9Corr > 0.5) || (fabs(pho_sceta) < 1.479  && pho_full5x5_r9Corr < 0.85 && pho_full5x5_r9Corr > 0.5 && pho_full5x5_sieieCorr < 0.015 && pho_pfPhoIso03Corr_effA < 4. && pho_TrackIsoMuCorr < 6.) || (fabs(pho_sceta) > 1.479  && pho_full5x5_r9Corr > 0.9 && pho_full5x5_r9Corr > 0.85) || (fabs(pho_sceta) > 1.479  && pho_full5x5_r9Corr < 0.9 && pho_full5x5_r9Corr > 0.8 && pho_full5x5_sieieCorr < 0.035 && pho_pfPhoIso03Corr_effA < 4. && pho_TrackIsoMuCorr < 6.) ) && pho_hoe < 0.08 && pho_MVAOutputCorr>-0.9 && pho_PassEleVeto>0 && pho_pt_ScaleSmeared*pho_FnufCorr>20.");
